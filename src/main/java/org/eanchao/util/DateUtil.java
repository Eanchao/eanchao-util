...
public class DateUtil {
	/**
	 * Date Style 日期格式：年月日时分秒 yyyyMMddHHmmss
	 */
	public static final String DATESTYLE = "yyyyMMddHHmmss";

	/**
	 * Date Style for Extention 日期格式：年-月-日_时-分-秒 yyyy-MM-dd_HH-mm-ss
	 */
	public static final String DATESTYLE_EX = "yyyy-MM-dd_HH-mm-ss";

	/**
	 * Date Style for Extention 日期格式：年-月-日 yyyy-MM-dd
	 */
	public static final String DATESTYLE_ = "yyyy-MM-dd";

	/**
	 * Date Style for Year & Month 日期格式-年月 yyyyMM
	 */
	public static final String DATESTYLE_YEAR_MONTH = "yyyyMM";

	/**
	 * Date Style for Short 日期格式-年月日 yyyyMMdd
	 */
	...
	/**
	 * Date Style for Year & Month Extention 日期格式：年/月 yyyy/MM
	 */
	public static final String DATESTYLE_YEAR_MONTH_EX = "yyyy/MM";

	/**
	 * Date Style for detail 日期格式：年月日时分秒毫秒
	 */
